...
#    lab2_list-2.png ... wait-for-lock time, and the average time per operation against the number of competing threads
#    lab2_list-3.png ... threads and iterations that run (protected) w/o failure
#    lab2_list-4.png ... mutex aggregated throughput vs. the number of threads
#    lab2_list-5.png ... spin aggregated throughput vs. the number of threads
#
...
set key left top
plot \
     "<grep -E 'list-none-m,[0-9],1000,1,|list-none-m,16,1000,1,|list-none-m,24,1000,1,' lab2_list.csv" \
...
set key left top
plot \
     "<grep -E 'list-id-none,[0-9]+,[0-9]+,4,' lab2_list.csv" \
     using ($2):($3) title 'no sync' with points lc rgb 'blue',\
     "<grep -E 'list-id-m,[0-9]+,[0-9]+,4,' lab2_list.csv" \
     using ($2):($3) title 'mutex' with points lc rgb 'red',\
     "<grep -E 'list-id-s,[0-9]+,[0-9]+,4,' lab2_list.csv" \
...
set key left top
plot \
     "<grep -E 'list-none-m,[1-9],1000,1,|list-none-m,12,1000,1,' lab2_list.csv" using ($2):(1000000000/($7))\
     title '1 list' with linespoints lc rgb 'blue' ,\
     "<grep -E 'list-none-m,[1-9]+,1000,4' lab2_list.csv" using ($2):(1000000000/($7))\
     title '4 list' with linespoints lc rgb 'brown' ,\
     "<grep -E 'list-none-m,[1-9]+,1000,8' lab2_list.csv" using ($2):(1000000000/($7))\
     title '8 list' with linespoints lc rgb 'red' ,\
     "<grep -E 'list-none-m,[1-9]+,1000,16' lab2_list.csv" using ($2):(1000000000/($7))\
...
set key left top
plot \
     "<grep -E 'list-none-s,[1-9],1000,1,|list-none-s,12,1000,1,' lab2_list.csv" using ($2):(1000000000/($7))\
     title '1 list' with linespoints lc rgb 'blue' ,\
     "<grep -E 'list-none-s,[1-9]+,1000,4' lab2_list.csv" using ($2):(1000000000/($7))\
     title '4 list' with linespoints lc rgb 'brown' ,\
     "<grep -E 'list-none-s,[1-9]+,1000,8' lab2_list.csv" using ($2):(1000000000/($7))\
     title '8 list' with linespoints lc rgb 'red' ,\
     "<grep -E 'list-none-s,[1-9]+,1000,16' lab2_list.csv" using ($2):(1000000000/($7))\
     title '16 list' with linespoints lc rgb 'green'
